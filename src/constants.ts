...
export const TRACK_HEIGHT = 78;
export const EFFECT_HEIGHT = TRACK_HEIGHT + 48;
...
export const PRO54_URL = "https://wam-4tt.pages.dev/Pro54/index.js";
...
export const OVERVIEW_TRACK_MIN_HEIGHT = 10;
export const OVERVIEW_MAX_HEIGHT = 58;
